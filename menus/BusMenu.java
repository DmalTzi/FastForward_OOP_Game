...
public class BusMenu extends SuperMenu {
    ...
    public BusMenu(GamePanel gp, String location, String vName) {
        ...
        defaultBg = new ImageIcon(
                LoadSave.GetSprite("menus", "menu_" + ((vName.equals("bus")) ? vName : location) + ".png"));
    ...
    private void setUpActionBtns() {
        ...
        allPossible[0].addMouseListener(new MouseListener() {
                ...
                int time = gp.getEventManager()
                        .goToNextEvent(Arrays.asList(gp.getEarth().getLocation())
                                ...
                                Arrays.asList(gp.getEarth().getLocation())
                                        .indexOf(gp.getEarth().getLocation()[0]),
                                vName);
                if (time > 0) {
            ...
            public void mouseEntered(MouseEvent e) {
                // hover
                allPossible[0].setIcon(new ImageIcon(
                        LoadSave.GetSprite("menus", "menu_bus" + ((vName.equals("bus")) ? "" : "_" + location) + "_"
                                + gp.getEarth().getLocation()[0] + "_hover.png")));
            }
        ...
        allPossible[1].addMouseListener(new MouseListener() {
            public void mouseReleased(MouseEvent e) {
                int time = gp.getEventManager()
                        .goToNextEvent(Arrays.asList(gp.getEarth().getLocation())
                                .indexOf(gp.getPlayer().getCurrentPosition()),
                                Arrays.asList(gp.getEarth().getLocation())
                                        .indexOf(gp.getEarth().getLocation()[1]),
                                vName);
                if (time > 0) {
                    menu.setVisible(false);
                    gp.getEarth().increaseTime(time);
            ...
            public void mouseEntered(MouseEvent e) {
                allPossible[1].setIcon(new ImageIcon(
                        LoadSave.GetSprite("menus", "menu_bus" + ((vName.equals("bus")) ? "" : "_" + location) + "_"
                                + gp.getEarth().getLocation()[1] + "_hover.png")));
                allPossible[1].setSize(allPossible[1].getIcon().getIconWidth(),
                        allPossible[1].getIcon().getIconHeight());
            }

            public void mouseExited(MouseEvent e) {
                allPossible[1].setIcon(new ImageIcon(
                        LoadSave.GetSprite("menus", "menu_bus" + ((vName.equals("bus")) ? "" : "_" + location) + "_"
                                + gp.getEarth().getLocation()[1] + ".png")));
                allPossible[1].setSize(allPossible[1].getIcon().getIconWidth(),
                        allPossible[1].getIcon().getIconHeight());
            }
        ...
        allPossible[2].addMouseListener(new MouseListener() {
            public void mouseReleased(MouseEvent e) {
                int time = gp.getEventManager()
                        .goToNextEvent(Arrays.asList(gp.getEarth().getLocation())
                                .indexOf(gp.getPlayer().getCurrentPosition()),
                                Arrays.asList(gp.getEarth().getLocation())
                                        .indexOf(gp.getEarth().getLocation()[2]),
                                vName);
                if (time > 0) {
                    menu.setVisible(false);
                    gp.getEarth().increaseTime(time);
            ...
            public void mouseEntered(MouseEvent e) {
                allPossible[2].setIcon(new ImageIcon(
                        LoadSave.GetSprite("menus", "menu_bus" + ((vName.equals("bus")) ? "" : "_" + location) + "_"
                                + gp.getEarth().getLocation()[2] + "_hover.png")));
                allPossible[2].setSize(allPossible[2].getIcon().getIconWidth(),
                        allPossible[2].getIcon().getIconHeight());
            }

            public void mouseExited(MouseEvent e) {
                allPossible[2].setIcon(new ImageIcon(
                        LoadSave.GetSprite("menus", "menu_bus" + ((vName.equals("bus")) ? "" : "_" + location) + "_"
                                + gp.getEarth().getLocation()[2] + ".png")));
                allPossible[2].setSize(allPossible[2].getIcon().getIconWidth(),
                        allPossible[2].getIcon().getIconHeight());
            }
        ...
        allPossible[3].addMouseListener(new MouseListener() {
            public void mouseReleased(MouseEvent e) {
                int time = gp.getEventManager()
                        .goToNextEvent(Arrays.asList(gp.getEarth().getLocation())
                                .indexOf(gp.getPlayer().getCurrentPosition()),
                                Arrays.asList(gp.getEarth().getLocation())
                                        .indexOf(gp.getEarth().getLocation()[3]),
                                vName);
                if (time > 0) {
                    menu.setVisible(false);
                    gp.getEarth().increaseTime(time);
            ...
            public void mouseEntered(MouseEvent e) {
                allPossible[3].setIcon(new ImageIcon(
                        LoadSave.GetSprite("menus", "menu_bus" + ((vName.equals("bus")) ? "" : "_" + location) + "_"
                                + gp.getEarth().getLocation()[3] + "_hover.png")));
                allPossible[3].setSize(allPossible[3].getIcon().getIconWidth(),
                        allPossible[3].getIcon().getIconHeight());
            }

            public void mouseExited(MouseEvent e) {
                allPossible[3].setIcon(new ImageIcon(
                        LoadSave.GetSprite("menus", "menu_bus" + ((vName.equals("bus")) ? "" : "_" + location) + "_"
                                + gp.getEarth().getLocation()[3] + ".png")));
                allPossible[3].setSize(allPossible[3].getIcon().getIconWidth(),
                        allPossible[3].getIcon().getIconHeight());
            }
    ...
    private void setUpBtns() {
        ...
        int checkEach = 0;
        // useCheck is, we chose 3 in 4 to show in our menu because we don't show
        // current event
        int useCheck = 0;

        // create all allPossible event
        allPossible[0] = new JButton();
        allPossible[0].setIcon(new ImageIcon(LoadSave.GetSprite("menus", "menu_bus"
                + ((vName.equals("bus")) ? "" : "_" + location) + "_" + gp.getEarth().getLocation()[0] + ".png")));
        allPossible[0].setSize(allPossible[0].getIcon().getIconWidth(), allPossible[0].getIcon().getIconHeight());

        allPossible[1] = new JButton();
        allPossible[1].setIcon(new ImageIcon(LoadSave.GetSprite("menus", "menu_bus"
                + ((vName.equals("bus")) ? "" : "_" + location) + "_" + gp.getEarth().getLocation()[1] + ".png")));
        allPossible[1].setSize(allPossible[1].getIcon().getIconWidth(), allPossible[1].getIcon().getIconHeight());

        allPossible[2] = new JButton();
        allPossible[2].setIcon(new ImageIcon(LoadSave.GetSprite("menus", "menu_bus"
                + ((vName.equals("bus")) ? "" : "_" + location) + "_" + gp.getEarth().getLocation()[2] + ".png")));
        allPossible[2].setSize(allPossible[2].getIcon().getIconWidth(), allPossible[2].getIcon().getIconHeight());

        allPossible[3] = new JButton();
        allPossible[3].setIcon(new ImageIcon(LoadSave.GetSprite("menus", "menu_bus"
                + ((vName.equals("bus")) ? "" : "_" + location) + "_" + gp.getEarth().getLocation()[3] + ".png")));
        ...
        while (checkEach < 4) {
            ...
            btns[useCheck].setLocation(
                    25 + (useCheck - 1 >= 0 ? btns[useCheck - 1].getLocation().x + btns[useCheck - 1].getWidth() : 75),
                    (menuHeight / 2) - 50);
            useCheck++;
            checkEach++;
        }
