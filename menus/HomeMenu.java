...
public class HomeMenu extends SuperMenu{
    ...
    public HomeMenu(GamePanel gp) {
        ...
        profile.setLocation(50, 30+title.getHeight());
    ...
    private void setUpBtns() {
        ...
        btns[0].setLocation(30+profile.getWidth() + profile.getLocation().x, 30+title.getHeight());
        ...
        btns[1].setLocation(30 + btns[0].getLocation().x+btns[0].getWidth(), 30+title.getHeight());
        ...
        btns[2].setLocation(30 + btns[1].getLocation().x+btns[1].getWidth(), 30+title.getHeight());
        ...
        btns[3].setLocation(30+profile.getWidth() + profile.getLocation().x, 30+btns[0].getLocation().y +btns[0].getHeight());
        ...
        btns[4].setLocation(30+btns[3].getWidth() + btns[3].getLocation().x, 30+btns[0].getLocation().y +btns[0].getHeight());
        ...
        btns[5].setLocation(30+btns[4].getWidth() + btns[4].getLocation().x, 30+btns[0].getLocation().y +btns[0].getHeight());
    }
}